...
export default function StudentModule() {
  return (
    <div className="min-h-screen w-full bg-[#0f1020] text-white flex items-center justify-center p-6">
      <div className="w-full max-w-5xl rounded-3xl bg-[#16172a] shadow-[0_20px_80px_-20px_rgba(0,0,0,.6)] ring-1 ring-white/5 p-6 md:p-10">
        ...
        {/* Heading */}
        <div className="mt-8">
          <h1 className="text-3xl md:text-4xl font-extrabold">Student Module</h1>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-5">
          <button className="group rounded-2xl p-5 text-left bg-gradient-to-br from-indigo-600 to-violet-700/90 hover:to-violet-600 transition shadow-lg shadow-violet-900/30 ring-1 ring-white/10">
            <div className="flex items-center gap-3">
          ...
          <button className="group rounded-2xl p-5 text-left bg-gradient-to-br from-rose-500 to-fuchsia-600 hover:to-fuchsia-500 transition shadow-lg shadow-fuchsia-900/30 ring-1 ring-white/10">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 grid place-items-center rounded-xl bg-white/15 ring-1 ring-white/10">
          ...
          <button className="group rounded-2xl p-5 text-left bg-gradient-to-br from-amber-400 to-orange-500 hover:to-orange-400 transition shadow-lg shadow-orange-900/20 ring-1 ring-white/10">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 grid place-items-center rounded-xl bg-white/15 ring-1 ring-white/10">
          ...
          <button className="group rounded-2xl p-5 text-left bg-gradient-to-br from-cyan-500 to-teal-600 hover:to-teal-500 transition shadow-lg shadow-teal-900/30 ring-1 ring-white/10">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 grid place-items-center rounded-xl bg-white/15 ring-1 ring-white/10">
